...
def sol_gen_coords(F,x,t,x0,tilde_w0):
    '''Input:
        d-dimensional x sample-dimensional initial condition x0 (specified as numpy array)
        d-dimensional x order-dimensional x sample-dimensional generalised fluctuations at the initial condition tilde_w0 (specified as numpy array)
    ...
    for n in range(N):
        ...
        for o in range(1,order +1):
            #evaluate (o-1)-th time derivative of F(x(t)) at the (o-1)-th,...,1st, 0th time derivatives of x(t) evaluated at t=0
...
# '''Simulation and test involving Lorentz system'''
#
